package org.compose_projects.socialocal.auth.ui.components.textField.styles
...
import org.compose_projects.socialocal.auth.ui.components.textField.config.TextFieldColors
...
object SLTextFieldColors {
    ...
    val defaultStyleLight: TextFieldColors
        get() = object :
            ...
            override val containerFocused: Color = md_theme_light_secondaryContainer.copy(0.65F)
            override val containerUnFocused: Color = md_theme_light_secondaryContainer.copy(0.55F)
            ...
            override val selectedFieldBorder: Color = md_theme_light_onPrimaryContainer
